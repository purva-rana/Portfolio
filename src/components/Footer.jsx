...
export default function Footer() {
  return (
    <footer className="border-t border-[rgba(255,255,255,0.05)] mt-12 py-6">
      <div className="max-w-5xl mx-auto px-6 flex justify-between items-center">
        {/* Copyright notice */}
        <p className="text-sm text-[color:var(--muted-gray)]">
          © {new Date().getFullYear()} Purva Rana. All Rights Reserved.
        </p>
